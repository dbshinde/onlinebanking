...
public class AdminController{
	...
	public String dashboard(HttpServletRequest request, HttpServletResponse response,
		...
		boolean isAdmin = Boolean.parseBoolean(session.getAttribute("isAdmin") != null ? session.getAttribute("isAdmin").toString(): "false");
		...
		if ( isAdmin )
		{
			...
			if(uris.get("uri_2").equals("account")){
				...
				if(uris.get("uri_3").equals("list")){
					List<Account> AccountsList = accountController.getAccounts();
...
//					return "redirect:admin/dashboard";
		...
		if(uris.get("uri_2").toString().equals("session"))
		{
			//Logout Request
			if(uris.get("uri_3").toString().equals("logout")){
				session.invalidate();
